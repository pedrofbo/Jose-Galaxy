...
#		t.origin = transform.origin
		transform.basis.y = planet.get_transform().basis.y.normalized()
...
func _on_Area_body_entered_plat4(body):
	if not is_on_floor():
		planet = get_parent().get_node("Plataforma4")
		print("yohohohoho")
		planet_num = 2
		print(up_direction)
...
func _on_Area_body_entered_plat5(body):
	if not is_on_floor():
		planet = get_parent().get_node("Plataforma5")
		print("yohohohohoho")
		planet_num = 2
		print(up_direction)


func _on_Area_body_entered_planeta3(body):
	if not is_on_floor():
		planet = get_parent().get_node("Planeta3")
		print("yoyoyo")
		planet_num = 3
		print(up_direction)
